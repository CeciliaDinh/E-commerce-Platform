...
--Customer
INSERT INTO [dbo].[Customer] ([CName], [CID], [UID], [Address], [Phone], [BAccount], [BName], [CPassword]) VALUES
('John Doe', 'C01', 'U01', '123 Main St, Anytown, USA', '1234567890', '11110000', 'Bank A', 'pass1'),
('Jane Smith', 'C02', 'U02', '456 Oak Ave, Smallville, USA', '2345678901', '22220000', 'Bank B', 'pass2'),
('Jim Brown', 'C03', 'U03', '789 Pine Rd, Lakeview, USA', '3456789012', '33330000', 'Bank C', 'pass3'),
('Jill Johnson', 'C04', 'U04', '321 Elm St, Metropolis, USA', '4567890123', '44440000', 'Bank D', 'pass4'),
('Jack Davis', 'C05', 'U05', '654 Maple Ave, Pleasantville, USA', '5678901234', '55550000', 'Bank E', 'pass5'),
('Alice Williams', 'C06', 'U06', '987 Cedar Rd, Riverview, USA', '6789012345', '66660000', 'Bank F', 'pass6'),
('Bob Martin', 'C07', 'U07', '147 Willow St, Hilltop, USA', '7890123456', '77770000', 'Bank G', 'pass7'),
('Charlie Thompson', 'C08', 'U08', '258 Poplar Ave, Seaside, USA', '8901234567', '88880000', 'Bank H', 'pass8'),
('Diana Garcia', 'C09', 'U09', '369 Birch Rd, Forestview, USA', '9012345678', '99990000', 'Bank I', 'pass9'),
('Ethan Martinez', 'C10', 'U10', '963 Spruce St, Valleyview, USA', '1234567890', '00001111', 'Bank J', 'pass10');

--Seller
INSERT INTO [dbo].[Seller] ([SID], [SName], [SPassword]) VALUES
('S01', 'Oliver Wilson', 'password1'),
('S02', 'Sophia Taylor', 'password2'),
('S03', 'Mason Moore', 'password3'),
('S04', 'Ava Anderson', 'password4'),
('S05', 'Liam Thomas', 'password5'),
('S06', 'Mia Jackson', 'password6'),
('S07', 'Lucas Martin', 'password7'),
('S08', 'Emma Thompson', 'password8'),
('S09', 'Noah Garcia', 'password9'),
('S10', 'Isabella Martinez', 'password10');
